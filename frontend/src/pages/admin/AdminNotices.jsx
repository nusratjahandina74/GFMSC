      ...
      <form onSubmit={submit} className="grid2" style={{marginTop:12}}>
        ...
        <div>
          ...
          <div className="flex gap-2" style={{marginTop:10}}>
            <button type="submit" className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-4 py-2 rounded-lg shadow-md transition-all">
            ...
            {editingId && (
              <button type="button" onClick={()=>{
                setEditingId(null);
                setForm({title:"", body:"", tag:"Notice"});
              }} className="bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 font-bold px-4 py-2 rounded-lg shadow-md transition-all">
                Cancel
              </button>
            )}
          </div>
